                ...
                fetch(
                  ...
                  .then(thirdData => {
                    this.setState({ reviews: thirdData }, () => {
                      ...
                      fetch(
                        this.state.singleManga.relationships.mediaRelationships
                          .links.related
                      )
                        .then(fifthData => fifthData.json())
                        .then(fifthData => {
                          this.setState(
                            { relatedMedia: fifthData.data },
                            () => {
                              fetch(
                                this.state.singleManga.relationships
                                  .mangaCharacters.links.self
                              )
